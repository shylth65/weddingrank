...
window.WEDDINGRANK_CONFIG = {
  ...
  SUPABASE_ANON_KEY: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYXNlIiwicmVmIjoibW96bXhrbWF5bmh4cXd6b3Z6aGkiLCJyb2xlIjoiYW5vbiIsImlhdCI6MTc4ODAwMTc3OSwiZXhwIjoyMTAzNTc3Nzc5fQ.JGM3NersbuC45dJsknLFxCvlxHpj0Z0-dHXe_WwBf6I"
};
try {
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  ["v58.js?v=5.8","v59.js?v=5.10","v511.js?v=5.11","v512.js?v=5.12","v513.js?v=5.13","v514.js?v=5.15","v516.js?v=5.16","v518.js?v=5.18","v519.js?v=5.19","v520.js?v=5.20","v521.js?v=5.21","v522.js?v=5.22","v523.js?v=5.23","ranking-limit-v534.js?v=5.47","home-top10-v535.js?v=5.46","editorial-methodology-v544.js?v=5.46","navigation-hotfix-v545.js?v=5.49","render-rescue-v560.js?v=5.61","list-five-v562.js?v=5.62"].forEach(u=>{const s=document.createElement("script");s.src=u;s.defer=true;document.body.appendChild(s)});
